...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card">
    <div class="card-header text-white" style="background: linear-gradient(135deg, #2c3e50, #34495e); color: #ffffff;">
        <h5></h5>
    </div>
                ...
                <tbody>
                    ...
                    foreach ($buku as $b) { ?>
                        <tr>
                            ...
                            <td><?= $b['dibooking']; ?></td>
                            <td>
                                <img width="80" src="<?= base_url('assets/img/upload/') . $b['gambar']; ?>" class="img-fluid img-thumbnail" alt="...">
                            </td>
                            <td>
                                <a href="<?= base_url('buku/ubahBuku/') . $b['id']; ?>" class="badge badge-info">
                                    <i class="fas fa-edit"></i> Ubah
                                </a>
                                <a href="<?= base_url('buku/hapusbuku/') . $b['id']; ?>" onclick="return confirm('Kamu yakin akan menghapus <?= $b['judul_buku']; ?> ?');" class="badge badge-danger">
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('buku'); ?>" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" id="stok" name="stok" placeholder="Masukkan nominal stok">
                    </div>
                    <div class="form-group">
