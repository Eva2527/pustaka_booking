    ...
    if ($this->form_validation->run() == false) {
        ...
        if (!empty($_FILES['gambar']['name'])) {
            ...
            if ($this->upload->do_upload('gambar')) {
                ...
                $allowed_mimes = ['image/jpeg', 'image/png', 'image/gif', 'image/webp', 'image/bmp', 'image/svg+xml'];

                if (!in_array($file_mime, $allowed_mimes)) {
                    unlink($this->upload->data('full_path')); // Hapus file yang tidak valid
                    $this->session->set_flashdata('pesan', '<div class="alert alert-danger alert-message" role="alert">Format gambar tidak didukung!</div>');
